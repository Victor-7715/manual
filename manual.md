...
## Что выполняет каждая команда git
 ...
 4. _**git merge**_ - Совмещение двух вариантов текста. Чтобы произошло совмещение нужно вызвать команду git merge "имя ветки для слияния с текущей".
 5. _**git branch -d**_ - Удаление веток.
